...
export default function EventCard({
  ...
  if (featured) {
    return (
      <div className="group grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-xl overflow-hidden border-2 border-[hsl(var(--border))] hover:border-[hsl(var(--primary))] hover:shadow-xl transition-all duration-300">
